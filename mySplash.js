class Splash {
 ...
 constructor() {
  ...
  this.name = createDiv("SiyuanHao");
  this.name.position(this.splashBorder+20, this.splashBorder+60);
  
  this.info = createDiv("You can read a bunch of stuff about my project here because I've been working very hard in this class and I have so much to say about my project, the way it works, and why I made it. It's such an incredable joy to be coding in p5js and also so amazing to be learning from such a skilled teacher like Bryan Jacobs. <p> I could go on and on and on. <p> <a href=https://editor.p5js.org/SiyuanHao/sketches/HvSX_Zh5C1>view code</a>");
